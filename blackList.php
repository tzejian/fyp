                                ...
                                <div class="navbar">
                                    ...
                                    <div class="navbar-collapse collapse">
                                        <ul class="nav navbar-nav navbar-right">
                                            <li class="active">
                                                <a class="smoth-scroll" href="#home" rel="external">Home <div class="ripple-wrapper"></div></a>
                                            </li>
                ...
                <div class="display-table">
                    <div class="display-table-cell">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12 ">
                                    <p style="color: white">Blacklisted volunteer</p>

                                    <table>
                                        <tr>
                                            <th>Blacklisted User</th>
                                            <th>Name</th>
                                            <th>NRIC</th>
                                            <th>Reasons</th>
                                        </tr>
